        ...
        <div className="w-full h-auto bg-slate-100 flex justify-center items-center">
            <GlobalContainer>
                <div className="w-full h-auto min-h-[200px] py-5">
                    <h1 className="text-3xl text-slate-600 font-semibold mt-10">Discover Our Featured Listings</h1>
                    ...
                    <ul className="w-full flex justify-center items-center gap-10 flex-wrap mt-5">
                        {properties?.slice(0, 6).map((item, ndx) => {
                            return (
                                <li key={ndx} className="group w-[30%] h-[480px] bg-white shadow-lg border-1 border-secondary/40 rounded-md hover:shadow-xl relative">
                                    ...
                                    <div className=" w-full h-[180px] bg-white flex justify-center items-start flex-col gap-2 px-5">
                                        <h2 className="text-lg h-[50px] font-semibold text-slate-700 cursor-pointer hover:underline overflow-hidden">{item?.title}</h2>
                                        <h4 className="text-sm  text-slate-400 overflow-hidden">{item?.location}</h4>
                                        <div className="w-full flex justify-between items-center">
                                            <div className="">12</div>
                                            <span className="w-[150px] h-[50px] p-4 border-2 border-slate-800 group-hover:bg-secondary group-hover:text-white group-hover:border-secondary duration-500 flex justify-center items-center text-lg font-semibold"> $ 1900/mon</span>
                                        </div>
                                    </div>
                    ...
                    <div className="w-full flex justify-center items-center py-10 pb-4">
                        <button className="text-md text-white duration-200 font-semibold bg-accent p-4 hover:bg-primary cursor-pointer">See All Properties <MdArrowOutward className=" text-2xl inline-block" /></button>
                    </div>
                </div>
            </GlobalContainer>
        </div>
