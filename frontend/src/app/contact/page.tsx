            ...
            <div className="w-full min-h-[900px] relative ">
                ...
                <div className="lg:absolute lg:w-[40%] w-full  min-h-[700px] pt-10 flex flex-wrap justify-start items-start gap-3.5 p-4 rounded-lg bg-gradient-to-r from-primary/80 to-secondary/80 top-28 left-28 border-2 border-slate-100">
                    ...
                    <div className="lg:w-[48%] w-[98%] flex flex-col justify-start items-start gap-1.5">
                        ...
                        <input type="text" placeholder="First Name" className="w-full p-2 border-white rounded-lg outline-none bg-white" />
                    </div>
                    <div className="lg:w-[48%] w-[98%] flex flex-col justify-start items-start gap-1.5">
                        <h4 className="text-md font-semibold text-white/90">Last Name</h4>
                        <input type="text" placeholder="Last Name" className="w-full p-2 border-white rounded-lg outline-none bg-white" />
                    </div>
                    <div className="lg:w-[48%] w-[98%] flex flex-col justify-start items-start gap-1.5">
                        <h4 className="text-md font-semibold text-white/90">Phone</h4>
                        <input type="text" placeholder="Phone" className="w-full p-2 border-white rounded-lg outline-none bg-white" />
                    </div>
                    <div className="lg:w-[48%] w-[98%] flex flex-col justify-start items-start gap-1.5">
                        <h4 className="text-md font-semibold text-white/90">Email</h4>
                        <input type="text" placeholder="Email" className="w-full p-2 border-white rounded-lg outline-none bg-white" />
                    </div>
                    ...
                    <div className="w-[98%] flex flex-col justify-start items-start gap-1.5">
                        ...
                        <input type="text" placeholder="Message" className="w-full h-[90px] p-2 border-white rounded-lg outline-none bg-white" />
                    </div>
                    <div className="w-full flex justify-center items-center mt-3.5">
                        <button className="p-2 rounded-sm bg-white/90 text-black font-semibold px-10">Submit Form <IoIosSend className="inline text-2xl" /></button>
                    </div>
                </div>
